...
const testimonials = [
  ...
  { quote: "MapMind changed how I understand the world. Everything I read now has a place, a context, and a connection.", name: "Aarush Tandon", role: "Global Thinker", flag: "🌍" },
];
